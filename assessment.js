...
var secondHero = heroes.splice(4,1);
...
var testArr = ['people', 'person', 'thing', 'person', 'place'];
var testStr = 'person';
...
// and returns an object with a message, author, and timestamp, that has
